...
class HikariChatAPI:
    ...
    async def init(
        ...
        module: "HikariChatMod",  # type: ignore
    ):
        """Entry point"""
        self._client = client
        self._db = db
...
class HikariChatMod(loader.Module):
    ...
    strings = {
        ...
        "version": (
            "<b>🪆 {}</b>\n\n"
            "<b>😌 Author: t.me/hhaacckk1</b>\n"
            "<b>📥 Downloaded from @hhaacckk1</b>\n"
            "<b>{}</b>"
        ),
        ...
        "banninja_report": (
            ...
            "<i>Deleted {} bot(-s)</i>\n\n"
            "🏹 <i>«BanNinja can handle any size of attack»</i> © <code>@hhaacckk1</code>"
        ),
        "confirm_rmfed": (
    ...
    strings_ru = {
        ...
        "fed": '💼 <b>Федерация "{}":</b>\n🔰 <b>Чаты:</b>\n<b>{}</b>\n🔰 <b>Каналы:</b>\n<b>{}</b>\n🔰 <b>Админы:</b>\n<b>{}</b>\n🔰 <b>Предупреждения: {}</b>\n',
        "version": "<b>🪆 {}</b>\n\n<b>😌 Автор: t.me/hhaacckk1</b>\n<b>📥 Скачано из @hhaacckk1</b>\n<b>{}</b>",
    ...
    async def client_ready(
        ...
        self.__doc__ = (
            "Advanced chat admin toolkit\nNow became free...\n\n💻 Developer: t.me/hhaacckk1\n📣 Downloaded from: @hhaacckk1\n\n"
            + f"📦Version: {version}\n"
